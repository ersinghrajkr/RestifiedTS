  ...
  private generatePackageJson(projectName: string): string {
    return JSON.stringify({
      ...
      "scripts": {
        ...
        "test:run": "npx mocha --require ts-node/register --require tsconfig-paths/register 'tests/**/*.test.ts' --reporter mochawesome --reporter-options reportDir=reports,reportFilename=test-report,json=true,html=false && npm run test:report",
        "test:unit": "npx mocha --require ts-node/register --require tsconfig-paths/register 'tests/unit/**/*.test.ts' --reporter mochawesome --reporter-options reportDir=reports,reportFilename=unit-report,json=true,html=false",
        "test:integration": "npx mocha --require ts-node/register --require tsconfig-paths/register 'tests/integration/**/*.test.ts' --reporter mochawesome --reporter-options reportDir=reports,reportFilename=integration-report,json=true,html=false",
        "test:smoke": "npx mocha --require ts-node/register --require tsconfig-paths/register --grep '@smoke' 'tests/**/*.test.ts' --reporter mochawesome --reporter-options reportDir=reports,reportFilename=smoke-report,json=true,html=false",
        "test:comprehensive": "npm run test:unit && npm run test:integration && npm run test:smoke && npm run test:merge && npm run test:report",
        "test:merge": "npx mochawesome-merge 'reports/*.json' -o reports/merged-report.json",
        "test:report": "npx marge reports/test-report.json --reportDir reports --reportFilename test-report --inline --charts --code --timestamp",
        "test:report:comprehensive": "npx marge reports/merged-report.json --reportDir reports --reportFilename comprehensive-report --inline --charts --code --timestamp",
        "test:clean": "npx rimraf reports && npx mkdirp reports",
        "test:watch": "nodemon --ext ts --watch tests --exec 'npm test'",
        "report": "npx restifiedts report --comprehensive --open",
